...
public class ButtonScript : MonoBehaviour
{
    ...
    {
        //emoteInQuestion.GetComponentInChildren<HGTextMeshProUGUI>().text = GetComponentInChildren<HGTextMeshProUGUI>().text;///COME BACK TO THIS?
    ...
    {
        //Settings.emote0.Value = ScrollManager.circularButtons[0].GetComponentInChildren<HGTextMeshProUGUI>().text;///COME BACK TO THIS?
    ...
    public void Finish()
    {
        ...
        {
            //AnimationReplacements.g.GetComponent<EmoteWheel>().RefreshWheels();///COME BACK TO THIS?
        }
