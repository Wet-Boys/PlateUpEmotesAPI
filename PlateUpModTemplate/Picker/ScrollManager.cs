...
public class ScrollManager : MonoBehaviour
{
    ...
    void Start()
    {
        //gameObject.transform.parent.Find("Wheels").gameObject.SetActive(true);///COME BACK TO THIS?
    ...
    {
        //ScrollManager.circularButtons[0].GetComponentInChildren<HGTextMeshProUGUI>().text = Settings.emote0.Value;///COME BACK TO THIS?
    ...
    {
        //if (!buttonTemplate || alreadySetup)///COME BACK TO THIS?
        //{
        //    return;
        //}
        //alreadySetup = true;
    ...
    {
        //if (first)///COME BACK TO THIS?
        //{
        //    Debug.Log($"EmoteAPI: Wanna see a cool NRE?");
        //    first = false;
        //}
